...
声明在基类中的虚函数，在基类中没有定义，但要求所有的派生类必须提供自己的实现方法吗。纯虚函数是抽象基类的一部分，用于提供一个**接口**供派生类实现。
...
![image-20240617152920235](D:\10Typora\06xinfa\images\202406171529391.png)    

![image-20240617152945894](D:\10Typora\06xinfa\images\202406171529999.png) 
...
- 基于多态、C++11新特性与泛型编程思想封装了可调用对象模版类，用于承接不同类型的函数指针和函数参数以生成对应的可调用对象，实现各进程对象与线程对象可接入任意函数作为任务函数
